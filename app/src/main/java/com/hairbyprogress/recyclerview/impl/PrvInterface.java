package com.hairbyprogress.recyclerview.impl;
...
public interface PrvInterface{
    ...
    void setPagingableListener(MyRecyclerView.PagingableListener pagingableListener);
    void setAdapter(RecyclerView.Adapter adapter);
    void scrollToPosition(int position);
    void smoothScrollToPosition(int position);
    void setLoadMoreFooter(BaseLoadMoreView loadMoreFooter);
    BaseLoadMoreView getLoadMoreFooter();
    void addOnScrollListener(MyRecyclerView.OnScrollListener onScrollLinstener);
